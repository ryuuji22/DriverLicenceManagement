package com.mitocode.auditservice;
...
public class AuditServiceApplication {
	...
	public AuditServiceApplication(ApplicationContext applicationContext) {
	...
	public OpenAPI springLicenseOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Audit Query API").description("Audit Query API").version("v0.0.1")
